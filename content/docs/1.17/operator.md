...
# How many seconds of work has done that is in progress and hasn’t been observed by work_duration. (gauge)
workqueue_unfinished_work_seconds{name="jaeger-controller"} 0
