...
See the [README](https://github.com/jaegertracing/jaeger/tree/v1.8.0/plugin/storage/es/README.md) for an in-depth overview of how Jaeger uses Elasticsearch for storage.
