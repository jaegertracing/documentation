...
* [Upgrade Badger v1 to v3](https://github.com/jaegertracing/jaeger/blob/v1.70.0/internal/storage/v1/badger/docs/upgrade-v1-to-v3.md)
* [Badger file permissions as non-root service](https://github.com/jaegertracing/jaeger/blob/v1.70.0/internal/storage/v1/badger/docs/storage-file-non-root-permission.md)
...
**Note**: See [README](https://github.com/jaegertracing/jaeger/blob/v1.70.0/internal/storage/v1/cassandra/schema/README.md) for more details on Cassandra schema management.
...
* ScyllaDB [can be used](https://github.com/jaegertracing/jaeger/blob/v1.70.0/docker-compose/scylladb/README.md) as a drop-in replacement for Cassandra since it uses the same data model and query language.
...
To use a remote storage as Jaeger storage backend, use `grpc` as the storage type and specify the remote gRPC server address. For more information, please refer to [internal/storage/v1/grpc](https://github.com/jaegertracing/jaeger/tree/v1.70.0/internal/storage/v1/grpc).
