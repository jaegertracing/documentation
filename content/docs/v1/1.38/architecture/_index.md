...
The Jaeger **collector** receives traces from the SDKs or Jaeger [agents](.//#agent), runs them through a processing pipeline for validation and clean-up/enrichment, and stores them in a storage backend.
