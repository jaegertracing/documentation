...
Jaeger exposes its components as public Go packages under [`components/`](https://github.com/jaegertracing/jaeger/tree/v2.21.0/components) in the Jaeger repository:
