...
[Examples of working configuration files](https://github.com/jaegertracing/jaeger/tree/v2.19.0/cmd/jaeger) are available in the Jaeger GitHub repository:
...
**Example**: A working Docker Compose setup covering forward / strip / rewrite proxy routings ships in the repository at [`examples/reverse-proxy/`](https://github.com/jaegertracing/jaeger/tree/v2.19.0/examples/reverse-proxy), with Apache httpd configs for each.

For background on the design, see [ADR-009](https://github.com/jaegertracing/jaeger/blob/v2.19.0/docs/adr/009-ui-base-path-auto-detection.md).
