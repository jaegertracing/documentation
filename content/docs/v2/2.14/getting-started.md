...
Then navigate to `http://localhost:8080`. See the [README](https://github.com/jaegertracing/jaeger/blob/v2.14.0/examples/hotrod/README.md) for other ways to run the demo.
