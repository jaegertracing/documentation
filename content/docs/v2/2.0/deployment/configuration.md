...
`remote_sampling` extension is responsible for running HTTP/gRPC servers that expose the [Remote Sampling API](../../architecture/apis/#remote-sampling-configuration-stable).
