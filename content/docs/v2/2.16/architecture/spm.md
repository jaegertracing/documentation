...
An example configuration is available in the Jaeger repository: [config-spm.yaml](https://github.com/jaegertracing/jaeger/tree/v2.16.0/cmd/jaeger/config-spm.yaml). The following steps are required to enable the SPM feature:
...
An example configuration is available in the Jaeger repository: [config-spm-elasticsearch.yaml](https://github.com/jaegertracing/jaeger/tree/v2.16.0/cmd/jaeger/config-spm-elasticsearch.yaml).
...
[spm-demo]: https://github.com/jaegertracing/jaeger/tree/v2.16.0/docker-compose/monitor
[metricsquery.proto]: https://github.com/jaegertracing/jaeger/blob/v2.16.0/model/proto/metrics/metricsquery.proto
[openmetrics.proto]: https://github.com/jaegertracing/jaeger/blob/v2.16.0/model/proto/metrics/openmetrics.proto#L53
...
[http-api-readme]: https://github.com/jaegertracing/jaeger/tree/v2.16.0/docker-compose/monitor#http-api
