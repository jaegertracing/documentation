...
See [sample configuration](https://github.com/jaegertracing/jaeger/blob/v2.6.0/cmd/jaeger/config-badger.yaml).

## Troubleshooting

* [Badger file permissions as non-root service](https://github.com/jaegertracing/jaeger/blob/v2.6.0/internal/storage/v1/badger/docs/storage-file-non-root-permission.md)
